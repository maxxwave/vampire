...
///=====================================================================================
/// Adaptive MC 
// contribution added by Razvan Ababei
//======================================================================================
// Standard Libraries
#include <cmath>
#include <cstdlib>
...
int MonteCarlo(){
   ...
   for(int m=0; m<mp::num_materials; ++m){
      ...
      double acceptance_ratio = (sim::mc_statistics_moves-sim::mc_statistics_reject)/sim::mc_statistics_moves;
    if(acceptance_ratio > 0.6){
      sigma_array[m] *= 2.0;}
    else { sigma_array[m] /=2.0;}
   }
